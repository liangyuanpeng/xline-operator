...
func (r ApiGetAPIVersionsRequest) Execute() (*IoK8sApimachineryPkgApisMetaV1APIGroupList, *http.Response, error) {
...
func (a *ApisApiService) GetAPIVersionsExecute(r ApiGetAPIVersionsRequest) (*IoK8sApimachineryPkgApisMetaV1APIGroupList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IoK8sApimachineryPkgApisMetaV1APIGroupList
	)
