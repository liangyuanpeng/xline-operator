...
// checks if the CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe{}

// CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
type CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe struct {
...
func NewCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe() *CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe {
	this := CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe{}
	return &this
}
...
func (o CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) MarshalJSON() ([]byte, error) {
...
func (o CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) ToMap() (map[string]interface{}, error) {
...
type NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe struct {
	value *CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe
	isSet bool
}

func (v NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) Get() *CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe {
	return v.value
}

func (v *NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) Set(val *CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe(val *CloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) *NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe {
	return &NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe{value: val, isSet: true}
}

func (v NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudXlineXlineoperatorV1alpha1XlineClusterSpecContainerReadinessProbe) UnmarshalJSON(src []byte) error {
	v.isSet = true
