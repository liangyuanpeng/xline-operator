...
func main() {
    ...
    // response from `DeleteRbacAuthorizationV1CollectionClusterRole`: IoK8sApimachineryPkgApisMetaV1Status
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.DeleteRbacAuthorizationV1CollectionClusterRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDeleteRbacAuthorizationV1CollectionClusterRoleRequest struct via the builder pattern
...
func main() {
    ...
    // response from `DeleteRbacAuthorizationV1CollectionClusterRoleBinding`: IoK8sApimachineryPkgApisMetaV1Status
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.DeleteRbacAuthorizationV1CollectionClusterRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDeleteRbacAuthorizationV1CollectionClusterRoleBindingRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ListRbacAuthorizationV1ClusterRole(context.Background()).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ListRbacAuthorizationV1ClusterRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListRbacAuthorizationV1ClusterRole`: IoK8sApiRbacV1ClusterRoleList
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ListRbacAuthorizationV1ClusterRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListRbacAuthorizationV1ClusterRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRoleBindingList ListRbacAuthorizationV1ClusterRoleBinding(ctx).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ListRbacAuthorizationV1ClusterRoleBinding(context.Background()).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ListRbacAuthorizationV1ClusterRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListRbacAuthorizationV1ClusterRoleBinding`: IoK8sApiRbacV1ClusterRoleBindingList
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ListRbacAuthorizationV1ClusterRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListRbacAuthorizationV1ClusterRoleBindingRequest struct via the builder pattern
...
> IoK8sApiRbacV1RoleList ListRbacAuthorizationV1NamespacedRole(ctx, namespace).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ListRbacAuthorizationV1NamespacedRole(context.Background(), namespace).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ListRbacAuthorizationV1NamespacedRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListRbacAuthorizationV1NamespacedRole`: IoK8sApiRbacV1RoleList
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ListRbacAuthorizationV1NamespacedRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListRbacAuthorizationV1NamespacedRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1RoleBindingList ListRbacAuthorizationV1NamespacedRoleBinding(ctx, namespace).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ListRbacAuthorizationV1NamespacedRoleBinding(context.Background(), namespace).Pretty(pretty).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ListRbacAuthorizationV1NamespacedRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListRbacAuthorizationV1NamespacedRoleBinding`: IoK8sApiRbacV1RoleBindingList
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ListRbacAuthorizationV1NamespacedRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListRbacAuthorizationV1NamespacedRoleBindingRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ListRbacAuthorizationV1RoleBindingForAllNamespaces(context.Background()).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ListRbacAuthorizationV1RoleBindingForAllNamespaces``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListRbacAuthorizationV1RoleBindingForAllNamespaces`: IoK8sApiRbacV1RoleBindingList
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ListRbacAuthorizationV1RoleBindingForAllNamespaces`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListRbacAuthorizationV1RoleBindingForAllNamespacesRequest struct via the builder pattern
...
> IoK8sApiRbacV1RoleList ListRbacAuthorizationV1RoleForAllNamespaces(ctx).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ListRbacAuthorizationV1RoleForAllNamespaces(context.Background()).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ListRbacAuthorizationV1RoleForAllNamespaces``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ListRbacAuthorizationV1RoleForAllNamespaces`: IoK8sApiRbacV1RoleList
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ListRbacAuthorizationV1RoleForAllNamespaces`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListRbacAuthorizationV1RoleForAllNamespacesRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRole PatchRbacAuthorizationV1ClusterRole(ctx, name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.PatchRbacAuthorizationV1ClusterRole(context.Background(), name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.PatchRbacAuthorizationV1ClusterRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchRbacAuthorizationV1ClusterRole`: IoK8sApiRbacV1ClusterRole
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.PatchRbacAuthorizationV1ClusterRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchRbacAuthorizationV1ClusterRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRoleBinding PatchRbacAuthorizationV1ClusterRoleBinding(ctx, name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.PatchRbacAuthorizationV1ClusterRoleBinding(context.Background(), name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.PatchRbacAuthorizationV1ClusterRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchRbacAuthorizationV1ClusterRoleBinding`: IoK8sApiRbacV1ClusterRoleBinding
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.PatchRbacAuthorizationV1ClusterRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchRbacAuthorizationV1ClusterRoleBindingRequest struct via the builder pattern
...
> IoK8sApiRbacV1Role PatchRbacAuthorizationV1NamespacedRole(ctx, name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.PatchRbacAuthorizationV1NamespacedRole(context.Background(), name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.PatchRbacAuthorizationV1NamespacedRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchRbacAuthorizationV1NamespacedRole`: IoK8sApiRbacV1Role
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.PatchRbacAuthorizationV1NamespacedRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchRbacAuthorizationV1NamespacedRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1RoleBinding PatchRbacAuthorizationV1NamespacedRoleBinding(ctx, name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.PatchRbacAuthorizationV1NamespacedRoleBinding(context.Background(), name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Force(force).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.PatchRbacAuthorizationV1NamespacedRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchRbacAuthorizationV1NamespacedRoleBinding`: IoK8sApiRbacV1RoleBinding
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.PatchRbacAuthorizationV1NamespacedRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchRbacAuthorizationV1NamespacedRoleBindingRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRole ReadRbacAuthorizationV1ClusterRole(ctx, name).Pretty(pretty).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReadRbacAuthorizationV1ClusterRole(context.Background(), name).Pretty(pretty).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReadRbacAuthorizationV1ClusterRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReadRbacAuthorizationV1ClusterRole`: IoK8sApiRbacV1ClusterRole
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReadRbacAuthorizationV1ClusterRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReadRbacAuthorizationV1ClusterRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRoleBinding ReadRbacAuthorizationV1ClusterRoleBinding(ctx, name).Pretty(pretty).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReadRbacAuthorizationV1ClusterRoleBinding(context.Background(), name).Pretty(pretty).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReadRbacAuthorizationV1ClusterRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReadRbacAuthorizationV1ClusterRoleBinding`: IoK8sApiRbacV1ClusterRoleBinding
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReadRbacAuthorizationV1ClusterRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReadRbacAuthorizationV1ClusterRoleBindingRequest struct via the builder pattern
...
> IoK8sApiRbacV1Role ReadRbacAuthorizationV1NamespacedRole(ctx, name, namespace).Pretty(pretty).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReadRbacAuthorizationV1NamespacedRole(context.Background(), name, namespace).Pretty(pretty).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReadRbacAuthorizationV1NamespacedRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReadRbacAuthorizationV1NamespacedRole`: IoK8sApiRbacV1Role
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReadRbacAuthorizationV1NamespacedRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReadRbacAuthorizationV1NamespacedRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1RoleBinding ReadRbacAuthorizationV1NamespacedRoleBinding(ctx, name, namespace).Pretty(pretty).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReadRbacAuthorizationV1NamespacedRoleBinding(context.Background(), name, namespace).Pretty(pretty).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReadRbacAuthorizationV1NamespacedRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReadRbacAuthorizationV1NamespacedRoleBinding`: IoK8sApiRbacV1RoleBinding
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReadRbacAuthorizationV1NamespacedRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReadRbacAuthorizationV1NamespacedRoleBindingRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRole ReplaceRbacAuthorizationV1ClusterRole(ctx, name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1ClusterRole(context.Background(), name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1ClusterRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReplaceRbacAuthorizationV1ClusterRole`: IoK8sApiRbacV1ClusterRole
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1ClusterRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReplaceRbacAuthorizationV1ClusterRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1ClusterRoleBinding ReplaceRbacAuthorizationV1ClusterRoleBinding(ctx, name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1ClusterRoleBinding(context.Background(), name).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1ClusterRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReplaceRbacAuthorizationV1ClusterRoleBinding`: IoK8sApiRbacV1ClusterRoleBinding
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1ClusterRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReplaceRbacAuthorizationV1ClusterRoleBindingRequest struct via the builder pattern
...
> IoK8sApiRbacV1Role ReplaceRbacAuthorizationV1NamespacedRole(ctx, name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1NamespacedRole(context.Background(), name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1NamespacedRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReplaceRbacAuthorizationV1NamespacedRole`: IoK8sApiRbacV1Role
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1NamespacedRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReplaceRbacAuthorizationV1NamespacedRoleRequest struct via the builder pattern
...
> IoK8sApiRbacV1RoleBinding ReplaceRbacAuthorizationV1NamespacedRoleBinding(ctx, name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1NamespacedRoleBinding(context.Background(), name, namespace).Body(body).Pretty(pretty).DryRun(dryRun).FieldManager(fieldManager).FieldValidation(fieldValidation).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1NamespacedRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ReplaceRbacAuthorizationV1NamespacedRoleBinding`: IoK8sApiRbacV1RoleBinding
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.ReplaceRbacAuthorizationV1NamespacedRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiReplaceRbacAuthorizationV1NamespacedRoleBindingRequest struct via the builder pattern
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent WatchRbacAuthorizationV1ClusterRole(ctx, name).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRole(context.Background(), name).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1ClusterRole`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1ClusterRoleRequest struct via the builder pattern
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent WatchRbacAuthorizationV1ClusterRoleBinding(ctx, name).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleBinding(context.Background(), name).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1ClusterRoleBinding`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1ClusterRoleBindingRequest struct via the builder pattern
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent WatchRbacAuthorizationV1ClusterRoleBindingList(ctx).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleBindingList(context.Background()).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleBindingList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1ClusterRoleBindingList`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleBindingList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1ClusterRoleBindingListRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleList(context.Background()).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1ClusterRoleList`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1ClusterRoleList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1ClusterRoleListRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRole(context.Background(), name, namespace).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRole``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1NamespacedRole`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRole`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1NamespacedRoleRequest struct via the builder pattern
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent WatchRbacAuthorizationV1NamespacedRoleBinding(ctx, name, namespace).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleBinding(context.Background(), name, namespace).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleBinding``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1NamespacedRoleBinding`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleBinding`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1NamespacedRoleBindingRequest struct via the builder pattern
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent WatchRbacAuthorizationV1NamespacedRoleBindingList(ctx, namespace).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleBindingList(context.Background(), namespace).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleBindingList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1NamespacedRoleBindingList`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleBindingList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1NamespacedRoleBindingListRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleList(context.Background(), namespace).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1NamespacedRoleList`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1NamespacedRoleList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1NamespacedRoleListRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1RoleBindingListForAllNamespaces(context.Background()).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1RoleBindingListForAllNamespaces``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1RoleBindingListForAllNamespaces`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1RoleBindingListForAllNamespaces`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1RoleBindingListForAllNamespacesRequest struct via the builder pattern
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent WatchRbacAuthorizationV1RoleListForAllNamespaces(ctx).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RbacAuthorizationV1Api.WatchRbacAuthorizationV1RoleListForAllNamespaces(context.Background()).AllowWatchBookmarks(allowWatchBookmarks).Continue_(continue_).FieldSelector(fieldSelector).LabelSelector(labelSelector).Limit(limit).Pretty(pretty).ResourceVersion(resourceVersion).ResourceVersionMatch(resourceVersionMatch).SendInitialEvents(sendInitialEvents).TimeoutSeconds(timeoutSeconds).Watch(watch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `RbacAuthorizationV1Api.WatchRbacAuthorizationV1RoleListForAllNamespaces``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `WatchRbacAuthorizationV1RoleListForAllNamespaces`: IoK8sApimachineryPkgApisMetaV1WatchEvent
    fmt.Fprintf(os.Stdout, "Response from `RbacAuthorizationV1Api.WatchRbacAuthorizationV1RoleListForAllNamespaces`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWatchRbacAuthorizationV1RoleListForAllNamespacesRequest struct via the builder pattern
