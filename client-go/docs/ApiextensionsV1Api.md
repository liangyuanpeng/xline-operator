...
Other parameters are passed through a pointer to a apiCreateApiextensionsV1CustomResourceDefinitionRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiDeleteApiextensionsV1CollectionCustomResourceDefinitionRequest struct via the builder pattern
