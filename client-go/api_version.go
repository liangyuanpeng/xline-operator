...
func (r ApiGetCodeVersionRequest) Execute() (*IoK8sApimachineryPkgVersionInfo, *http.Response, error) {
...
func (a *VersionApiService) GetCodeVersionExecute(r ApiGetCodeVersionRequest) (*IoK8sApimachineryPkgVersionInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IoK8sApimachineryPkgVersionInfo
	)
